...
if __name__ == "__main__":
    ...
    running_dir = f"../model/supervised_agent/{args.seed}"
    ...
    # data setup
    train_files = glob.glob('../data/samples/train/sample_*.pkl')
    valid_files = glob.glob('../data/samples/valid/sample_*.pkl')
